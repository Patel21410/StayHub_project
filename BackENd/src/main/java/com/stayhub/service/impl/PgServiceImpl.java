...
public class PgServiceImpl implements PgService {
	...
	@Override
	public List<Pg> allPg() {
		List<Pg> PgaLlList = pgRepository.findAll();
		return PgaLlList;
	}


	@Override
	public List<Pg> fivePg() {
//		List<Pg> sixPgList = pgRepository.findSixPg((Pageable) PageRequest.of(0, 6));
		List<Pg> top6ByOrderByIdAsc = pgRepository.findTop6ByOrderByIdAsc();
		return top6ByOrderByIdAsc;
	}
